...
def create_lmdb_for_RealBlurJ():
    folder_path = './datasets/RealBlur_J/train/blur_crops'
    lmdb_path = './datasets/RealBlur_J/train/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/RealBlur_J/train/sharp_crops'
    lmdb_path = './datasets/RealBlur_J/train/sharp_crops.lmdb'
...
def create_lmdb_for_RealBlurR():
    folder_path = './datasets/RealBlur_R/train/blur_crops'
    lmdb_path = './datasets/RealBlur_R/train/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/RealBlur_R/train/sharp_crops'
    lmdb_path = './datasets/RealBlur_R/train/sharp_crops.lmdb'
...
def create_lmdb_for_test(root_path, name, sub_name=None, phase='test'):
    ...
    lmdb_path = f'{root_path}/{name}/{sub_name}{phase}/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = f'{root_path}/{name}/{sub_name}{phase}/target'
    lmdb_path = f'{root_path}/{name}/{sub_name}{phase}/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

if __name__ == '__main__':
    create_lmdb_for_test('./datasets', 'RSBlur-syn', phase='test')
